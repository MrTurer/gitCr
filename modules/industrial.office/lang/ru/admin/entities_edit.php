...
$MESS['PMO_ENTITY_FIELD_USE_TIME'] = 'Учитывать время';
$MESS['PMO_ENTITY_FIELD_RESOLUTION'] = 'Обязательность резолюции (решения)';
$MESS['PMO_ENTITY_FIELD_ICON'] = 'Изображение';
$MESS['PMO_ENTITY_FIELD_ICON_CODE'] = 'Символьный код, вместо изображения';
$MESS['PMO_ENTITY_FIELD_COLOR'] = 'Цвет';
$MESS['PMO_ERROR_EMPTY_NAME'] = 'Не заполнено обязательное поле "Название"';
$MESS['PMO_ERROR_EMPTY_ICON'] = 'Не заполнено поле "Изображение"';
